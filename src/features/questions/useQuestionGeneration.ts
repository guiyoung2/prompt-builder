...
3. 선택지가 있는 경우 choices를 제공하되, 아래 두 가지 예외는 반드시 지킬 것:
   a. 조합이 너무 많은 질문(예: 프레임워크 + 스타일링 라이브러리)은 하나의 질문으로 묶지 말고 두 질문으로 나눌 것.
   b. 모든 single/multi 질문의 choices 마지막에는 반드시 { "id": "other", "label": "직접 입력" } 항목을 추가할 것.
...
{
  "questions": [
    { "id": "q1", "text": "...", "type": "single", "choices": [{ "id": "c1", "label": "..." }, { "id": "other", "label": "직접 입력" }] },
